<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="The advertisement url" prop="url">
        <el-input v-model="dataForm.url" placeholder="The advertisement url"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        url: [
          {required: true, message: 'The advertisement url不能为空', trigger: 'blur'}
        ],
        note: [
          {required: true, message: '不能为空', trigger: 'blur'}
        ],
