<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="subject sub-title" prop="subTitle">
        <el-input v-model="dataForm.subTitle" placeholder="subject sub-title"></el-input>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        name: [
          {required: true, message: 'subject name不能为空', trigger: 'blur'}
        ],
        title: [
          {required: true, message: 'subject title不能为空', trigger: 'blur'}
        ],
        subTitle: [
          {required: true, message: 'subject sub-title不能为空', trigger: 'blur'}
        ],
        status: [
