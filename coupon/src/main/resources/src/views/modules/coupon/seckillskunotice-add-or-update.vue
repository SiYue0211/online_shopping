<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="0: message 1: email" prop="noticeType">
        <el-input v-model="dataForm.noticeType" placeholder="0: message 1: email"></el-input>
      </el-form-item>
    </el-form>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        noticeType: [
          {required: true, message: '0: message 1: email不能为空', trigger: 'blur'}
        ]
      }
    }
  },
