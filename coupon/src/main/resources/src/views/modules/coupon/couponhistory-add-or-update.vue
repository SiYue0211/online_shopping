<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="0: Backstage gift; 1: Pick up by users" prop="getType">
        <el-input v-model="dataForm.getType" placeholder="0: Backstage gift; 1: Pick up by users"></el-input>
      </el-form-item>
      <el-form-item label="" prop="createTime">
        <el-input v-model="dataForm.createTime" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="0: Unused 1: Used 2: Expired" prop="useType">
        <el-input v-model="dataForm.useType" placeholder="0: Unused 1: Used 2: Expired"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        getType: [
          {required: true, message: '0: Backstage gift; 1: Pick up by users不能为空', trigger: 'blur'}
        ],
        createTime: [
          {required: true, message: '不能为空', trigger: 'blur'}
        ],
        useType: [
          {required: true, message: '0: Unused 1: Used 2: Expired不能为空', trigger: 'blur'}
        ],
        useTime: [
          {required: true, message: '不能为空', trigger: 'blur'}
        ],
