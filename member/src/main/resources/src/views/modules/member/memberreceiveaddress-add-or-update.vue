  ...
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="receiver name" prop="name">
        <el-input v-model="dataForm.name" placeholder="receiver name"></el-input>
      </el-form-item>
      <el-form-item label="receiver phone" prop="phone">
        <el-input v-model="dataForm.phone" placeholder="receiver phone"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        phone: [
          {required: true, message: 'receiver phone不能为空', trigger: 'blur'}
        ],
        postCode: [
