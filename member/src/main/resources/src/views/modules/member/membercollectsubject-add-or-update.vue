<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="subject url" prop="subjectUrl">
        <el-input v-model="dataForm.subjectUrl" placeholder="subject url"></el-input>
      </el-form-item>
    </el-form>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        subjectUrl: [
          {required: true, message: 'subject url不能为空', trigger: 'blur'}
        ]
      }
    }
  },
