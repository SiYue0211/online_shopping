<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="Source of poitns: 0-shopping, 1-from administer" prop="sourceType">
        <el-input v-model="dataForm.sourceType"
                  placeholder="Source of poitns: 0-shopping, 1-from administer"></el-input>
      </el-form-item>
    </el-form>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        sourceType: [
          {required: true, message: 'Source of poitns: 0-shopping, 1-from administer不能为空', trigger: 'blur'}
        ]
      }
    }
  },
