<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="Source of poitns: 0-shopping, 1-from administer, 2-special events" prop="sourceTyoe">
        <el-input v-model="dataForm.sourceTyoe"
                  placeholder="Source of poitns: 0-shopping, 1-from administer, 2-special events"></el-input>
      </el-form-item>
    </el-form>
    ...
    return {
      ...
      dataRule: {
        ...
        sourceTyoe: [
          {
            required: true,
            message: 'Source of poitns: 0-shopping, 1-from administer, 2-special events不能为空',
            trigger: 'blur'
          }
        ]
      }
