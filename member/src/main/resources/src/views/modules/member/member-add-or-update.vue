<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="The source of points" prop="sourceType">
        <el-input v-model="dataForm.sourceType" placeholder="The source of points"></el-input>
      </el-form-item>
      <el-form-item label="points" prop="integration">
        <el-input v-model="dataForm.integration" placeholder="points"></el-input>
      </el-form-item>
      <el-form-item label="growth points" prop="growth">
        <el-input v-model="dataForm.growth" placeholder="growth points"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        header: [
          {required: true, message: 'avatar不能为空', trigger: 'blur'}
        ],
        gender: [
          {required: true, message: '不能为空', trigger: 'blur'}
        ],
        ...
        sourceType: [
          {required: true, message: 'The source of points不能为空', trigger: 'blur'}
        ],
        integration: [
          {required: true, message: 'points不能为空', trigger: 'blur'}
        ],
        growth: [
