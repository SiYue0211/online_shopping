<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="0: pending 1: in the return 2: finished 3: declined" prop="status">
        <el-input v-model="dataForm.status"
                  placeholder="0: pending 1: in the return 2: finished 3: declined"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        status: [
          {required: true, message: '0: pending 1: in the return 2: finished 3: declined不能为空', trigger: 'blur'}
        ],
        handleTime: [
          {required: true, message: '不能为空', trigger: 'blur'}
        ],
