<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="0: pending payment 1: wait to mail 2: mailed 3: finished 4: closed 5: cancelled"
                    prop="orderStatus">
        <el-input v-model="dataForm.orderStatus"
                  placeholder="0: pending payment 1: wait to mail 2: mailed 3: finished 4: closed 5: cancelled"></el-input>
      </el-form-item>
    ...
    return {
      ...
      dataRule: {
        ...
        orderStatus: [
          {
            required: true,
            message: '0: pending payment 1: wait to mail 2: mailed 3: finished 4: closed 5: cancelled不能为空',
            trigger: 'blur'
          }
        ],
        note: [
