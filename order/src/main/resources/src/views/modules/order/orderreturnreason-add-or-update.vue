<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="reason name" prop="name">
        <el-input v-model="dataForm.name" placeholder="reason name"></el-input>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        name: [
          {required: true, message: 'reason name不能为空', trigger: 'blur'}
        ],
        sort: [
