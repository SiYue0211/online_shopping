<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="sku number" prop="skuNum">
        <el-input v-model="dataForm.skuNum" placeholder="sku number"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        skuNum: [
          {required: true, message: 'sku number不能为空', trigger: 'blur'}
        ],
        taskId: [
          {required: true, message: 'task id不能为空', trigger: 'blur'}
        ]
      }
    }
  },
