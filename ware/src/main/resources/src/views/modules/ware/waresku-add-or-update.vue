<template>
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="stock number" prop="stock">
        <el-input v-model="dataForm.stock" placeholder="stock number"></el-input>
      </el-form-item>
      <el-form-item label="sku_name" prop="skuName">
        <el-input v-model="dataForm.skuName" placeholder="sku_name"></el-input>
      </el-form-item>
      <el-form-item label="locked stock number" prop="stockLocked">
        <el-input v-model="dataForm.stockLocked" placeholder="locked stock number"></el-input>
      </el-form-item>
    </el-form>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        stock: [
          {required: true, message: 'stock number不能为空', trigger: 'blur'}
        ],
        skuName: [
          {required: true, message: 'sku_name不能为空', trigger: 'blur'}
        ],
        stockLocked: [
          {required: true, message: 'locked stock number不能为空', trigger: 'blur'}
        ]
      }
    }
  },
